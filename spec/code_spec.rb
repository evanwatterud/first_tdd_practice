...
describe "substract_or_multiply_by_two" do
  it "should substract two if given a negative number" do
    result = substract_or_multiply_by_two(-3)
    expect(result).to eq(-5)
  end

  it "should multiply by two if given zero" do
    result = substract_or_multiply_by_two(0)
    expect(result).to eq(0)
  end

  it "should multiply by two if given a positive number" do
    result = substract_or_multiply_by_two(4)
